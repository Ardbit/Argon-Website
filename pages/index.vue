<template>
    <main>
        <section>
            <div>
                <h1 class="title"> Argon </h1>
                <p class="subtitle">
                    Elevate your server.
                </p>
                <div style="height: 100px"></div>
                <a class="button button--blurple" target="_blank" href="https://discord.com/oauth2/authorize?client_id=776342842543964210&permissions=8&scope=bot">
               ...
               "
                ...
                <a class="button button--greyple" href="https://discord.gg/5yGanxWBHv">Support Server</a>
                <a class="button button--blurple" href="/login">
                    Login with <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 800 272.1" fill="#FFFFFF">
